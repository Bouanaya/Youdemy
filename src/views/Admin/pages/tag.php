...
$count_tag = crud::select('tags', 'count(*) as total');
...
</svg><a href="./tag.php" class=" text-green-300">Tags</a></li>
                <li class="px-4 py-2 hover:bg-gray-800 rounded flex gap-2"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 text-white">
        ...
        <div class="module w-1/3  h-full z-50">
            <div class="form-container absolute w-full h-full bg-white p-8">
                <div class="flex justify-between items-center  mb-6">
                    <?php
                    if (isset($_GET['action']) && $_GET['action'] == 'update') {
                        echo '<h2 class="text-2xl">UPDATE THE TEGS : </h2>';
                        echo '<a href="./tag.php" >
                        ...
                        echo '<h2 class="text-2xl">CREATE THE TEGS : </h2>';
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6M6 6l12 12" />
                ...
                <form action="../../../Controllers/Tag.php" method="post">
                    ...
                    <div class="parent">
                        ...
                        <input type="text" id="tag" name="<?php
                        if (isset($_GET['action']) && $_GET['action'] == 'update') {
                            echo 'tags';
                        } else {
                            echo 'tags[]';
                        ...
                        ?>" placeholder="Enter a tag  PHP, Laravel, API ..." value="<?= $updatetag[0]["tagName"] ?? '' ?>" required>
                        <input type="hidden" name="id" value="<?= $updatetag[0]['tagId']; ?>">
                    ...
                    if (isset($_GET['action']) && $_GET['action'] == 'update') {
                        ...
                        echo ' <input type="submit" name="update" value="Update " class="bg-blue-400 cursor-pointer text-white py-1 px-2 rounded hover:bg-blue-600 w-full">';
                    } else {
                        echo '<button class="my-2 py-1 px-3 rounded text-white bg-blue-400 addTag">Add Tag</button>';
